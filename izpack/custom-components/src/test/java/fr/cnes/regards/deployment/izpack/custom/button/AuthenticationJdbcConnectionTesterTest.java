...
/**
 * Unit test for {@link AuthenticationJdbcConnectionTester}
 *
 * @author Christophe Mertz
 */
public class AuthenticationJdbcConnectionTesterTest {
    ...
    private boolean launchTest() {
        AuthenticationJdbcConnectionTester tester = new AuthenticationJdbcConnectionTester(installData);
