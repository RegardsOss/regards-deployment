...
/**
 * Unit test for {@link AdminProjectJdbcConnectionTester}
 *
 * @author Christophe Mertz
 */
public class AdminProjectJdbcConnectionTesterTest {
    
    private static final String URL = "172.26.47.52:5432/rs_admin_tenant0";
    ...
    private boolean launchTest() {
        AdminProjectJdbcConnectionTester tester = new AdminProjectJdbcConnectionTester(installData);
