...
public class DataProviderJdbcConnectionTester extends AbstractJdbcConnectionTester {
     ...
     */
    public static final String URL_DATASOURCE_VARIABLE = "regards.config.dataprovider.regards.jpa.multitenant.tenants.url.1";

    /**
     * The name of the username datasource variable in the install data
     */
    public static final String USERNAME_DATASOURCE_VARIABLE = "regards.config.dataprovider.regards.jpa.multitenant.tenants.user.name.1";
