...
/**
 * Test class for {@link ValidatorCatalogPanel}.
 *
 * @author Xavier-Alexandre Brochard
 * @since 1.0.0
 */
public class ValidatorCatalogPanelTest {
    ...
    public void testValidateData() {
        ...
        final String MICROSERVICE_IDENTIFIER = "catalog";
        ...
        ValidatorCatalogPanel validatorCatalogPanel = new ValidatorCatalogPanel();

        Status status = validatorCatalogPanel.validateData(installData);
