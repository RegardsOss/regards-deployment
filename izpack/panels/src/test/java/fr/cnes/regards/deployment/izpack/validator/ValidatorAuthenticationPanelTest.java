...
/**
 * Test class for {@link ValidatorAuthenticationPanel}.
 *
 * @author Xavier-Alexandre Brochard
 * @since 1.0.0
 */
public class ValidatorAuthenticationPanelTest {
    ...
    public void testValidateData() {
        ...
        final String MICROSERVICE_IDENTIFIER = "authentication";
        ...
        ValidatorAuthenticationPanel validatorAuthenticationPanel = new ValidatorAuthenticationPanel();

        Status status = validatorAuthenticationPanel.validateData(installData);
